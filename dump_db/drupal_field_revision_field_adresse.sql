...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Revision archive storage for field 11 (field_adresse)';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `field_revision_field_adresse`
--

LOCK TABLES `field_revision_field_adresse` WRITE;
/*!40000 ALTER TABLE `field_revision_field_adresse` DISABLE KEYS */;
/*!40000 ALTER TABLE `field_revision_field_adresse` ENABLE KEYS */;
UNLOCK TABLES;
