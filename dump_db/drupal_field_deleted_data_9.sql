...
--
-- Table structure for table `field_deleted_data_9`
--

DROP TABLE IF EXISTS `field_deleted_data_9`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `field_deleted_data_9` (
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Data storage for field 9 (field_address)';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `field_deleted_data_9`
--

LOCK TABLES `field_deleted_data_9` WRITE;
/*!40000 ALTER TABLE `field_deleted_data_9` DISABLE KEYS */;
/*!40000 ALTER TABLE `field_deleted_data_9` ENABLE KEYS */;
UNLOCK TABLES;
