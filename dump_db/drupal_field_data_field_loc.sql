...
--
-- Table structure for table `field_data_field_loc`
--

DROP TABLE IF EXISTS `field_data_field_loc`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `field_data_field_loc` (
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Data storage for field 12 (field_loc)';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `field_data_field_loc`
--

LOCK TABLES `field_data_field_loc` WRITE;
/*!40000 ALTER TABLE `field_data_field_loc` DISABLE KEYS */;
/*!40000 ALTER TABLE `field_data_field_loc` ENABLE KEYS */;
UNLOCK TABLES;
