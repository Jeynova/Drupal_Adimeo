...
--
-- Table structure for table `field_deleted_revision_10`
--
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Revision archive storage for field 10 (field_location)';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `field_deleted_revision_10`
--

LOCK TABLES `field_deleted_revision_10` WRITE;
/*!40000 ALTER TABLE `field_deleted_revision_10` DISABLE KEYS */;
/*!40000 ALTER TABLE `field_deleted_revision_10` ENABLE KEYS */;
UNLOCK TABLES;
